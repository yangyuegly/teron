...
class TronProblem(AdversarialSearchProblem):
    def __init__(self, board_file_loc, first_player):
        ...
        self._start_state = TronState(
            board, player_locs, first_player, player_powerups)
    ...
    def transition(self, state, action):
        ...
        if cell == CellType.SPACE:  # move to empty space
            TronProblem._move_player_and_update(
                board, state, player_locs, r1, c1)
